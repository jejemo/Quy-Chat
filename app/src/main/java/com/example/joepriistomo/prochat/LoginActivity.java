...
public class LoginActivity extends AppCompatActivity {
    ...
    static final String APP_ID = "65939";
    static final String AUTH_KEY = "yRA-uv7vk8hn6ed";
    static final String AUTH_SECRET = "AgvFUTkeNQBxuzD";
    static final String ACCOUNT_KEY = "s9iukf1MkKe5GhbW1cUc";
